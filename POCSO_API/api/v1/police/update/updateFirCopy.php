...
try {
    ...
    $requiredFields = ['id', 'FIR', 'FIR_ATTACH_FILENAME', 'FIR_ATTACH_MIMETYPE'];
    $missingFields = [];
    ...
    $FIR = $inputData['FIR'];
    $FIR_ATTACH_FILENAME = $inputData['FIR_ATTACH_FILENAME'];
    $FIR_ATTACH_MIMETYPE = $inputData['FIR_ATTACH_MIMETYPE'];
    ...
    $sql_stmt->bindParam(':P50_FIR', $FIR, PDO::PARAM_STR);
    $sql_stmt->bindParam(':P50_FIR_ATTACH_FILENAME', $FIR_ATTACH_FILENAME, PDO::PARAM_STR);
    $sql_stmt->bindParam(':P50_FIR_ATTACH_MIMETYPE', $FIR_ATTACH_MIMETYPE, PDO::PARAM_STR);
